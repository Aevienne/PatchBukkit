package org.patchbukkit.structure;
...
public class PatchBukkitStructureManager implements StructureManager {
    ...
    public @Nullable Structure getStructure(@NotNull NamespacedKey structureKey) {
        return this.structures.get(structureKey);
    }

    @Override
    public @NotNull Structure registerStructure(@NotNull NamespacedKey structureKey, @NotNull Structure structure) {
        this.structures.put(structureKey, structure);
        return structure;
    }

    @Override
    public @Nullable Structure unregisterStructure(@NotNull NamespacedKey structureKey) {
        return this.structures.remove(structureKey);
    }

    @Override
    public @Nullable Structure loadStructure(@NotNull NamespacedKey structureKey, boolean updateFlags) {
        return this.structures.get(structureKey);
    }
    ...
    public void deleteStructure(@NotNull NamespacedKey structureKey) throws IOException {
        this.structures.remove(structureKey);
    }
    ...
    public @NotNull File getStructureFile(@NotNull NamespacedKey structureKey) {
        return new File(structureKey.getKey() + ".nbt");
    }
    ...
    public @NotNull Structure createStructure() {
        return (Structure) java.lang.reflect.Proxy.newProxyInstance(
            Structure.class.getClassLoader(),
